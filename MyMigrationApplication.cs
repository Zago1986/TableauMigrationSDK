...
namespace Csharp.ExampleApplication
{
    internal sealed class MyMigrationApplication : IHostedService
    {
        ...
        private readonly List<MigrationListEntry> _migrationList;
        ...
        public async Task StartAsync(CancellationToken cancel)
        {
            ...
            _planBuilder = _planBuilder
                .FromSourceTableauServer(_options.Source.ServerUrl, _options.Source.SiteContentUrl, _options.Source.AccessTokenName, _options.Source.PersonalAccessToken)
                .ToDestinationTableauCloud(_options.Destination.ServerUrl, _options.Destination.SiteContentUrl, _options.Destination.AccessTokenName, _options.Destination.PersonalAccessToken)
                .ForServerToCloud()
